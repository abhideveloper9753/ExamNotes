...
function TopicForm({ setResult, setLoading, loading, setError }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const apiRes = await generateNotes({topic,
        classLevel,
        examType,
        revisionMode,
        includeDiagram,
        ...
        // server returns { data: <aiResponse>, noteId, creditsLeft }
        const normalized = apiRes?.data ?? apiRes
        ...
        if(typeof apiRes?.creditsLeft === "number"){
          dispatch(updateCredits(apiRes.creditsLeft));
